...
def _fused_add_rmsnorm_h4096(
    ...
    # x and residual are loaded as f
    ...
    # Compute variance using tl.dot for efficient accumulation
    # This leverages the 2-CTA TMEM architecture on Blackwell
    var = tl.dot(h * h, tl.zeros([BLOCK_H, 1], dtype=tl.float32), out_dtype=tl.float32) / H
